...
---"""
    ...
    def test_generate_game_detail_section_with_description_and_sources(self) -> None:
        ...
        expected_attribution = "([Claude](https://www.anthropic.com/claude) generated this text using instructions, the NERD scores, and these sources: [1](https://example.com/article1), [2](https://example.com/article2).)"
    ...
    def test_generate_game_detail_section_with_description_no_sources(self) -> None:
        ...
        expected_attribution = "([Claude](https://www.anthropic.com/claude) generated this text using instructions and the NERD scores.)"
        assert expected_attribution in result
    ...
    def test_generate_game_detail_section_with_description_sources_no_url(self) -> None:
        ...
        expected_attribution = "([Claude](https://www.anthropic.com/claude) generated this text using instructions, the NERD scores, and these sources: 1, [2](https://example.com/article2).)"
        assert expected_attribution in result
