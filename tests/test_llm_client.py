...
class TestOpenAIClient:
    ...
    def test_init_missing_openai_package(self):
        ...
        with patch('mlb_watchability.llm_client.openai', None):
    ...
    def test_generate_text_success(self):
        ...
        with patch('openai.OpenAI') as mock_openai_class:
            ...
            response = client.generate_text("Test prompt", max_tokens=150, temperature=0.5)
    ...
    def test_generate_text_with_custom_model(self):
    ...
    def test_generate_text_empty_response(self):
...
class TestGenerateSummary:
    ...
    def test_generate_summary_with_custom_model(self):
...
class TestIntegrationScenarios:
    ...
    def test_end_to_end_mock_workflow(self):
        ...
        mock_choice = Mock()
        mock_choice.message.content = "This is a comprehensive game summary with analysis."
        ...
        with patch('openai.OpenAI') as mock_openai_class:
            ...
            with patch.dict(os.environ, {"OPENAI_API_KEY": "test-api-key"}):
                ...
                assert response.content == "This is a comprehensive game summary with analysis."
                assert response.model == "gpt-4o"
                ...
                mock_client.chat.completions.create.assert_called_once_with(**expected_call)