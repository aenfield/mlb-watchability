...
def calculate_tnerd(batting_stats, payroll_data):
    ...
    constant = 4.0
    merged_data['tNERD'] = (merged_data['z_Bat'] + 
...
def main():
    ...
    display_columns = ['Team', 'Bat', 'z_Bat', 'Barrel%', 'z_Barrel', 'BsR', 'z_BsR', 'Fld', 'z_Fld', 'Payroll', 'z_Pay', 'Age', 'Payroll_Age', 'z_Age', 'wRC', 'R', 'Luck', 'z_Luck', 'tNERD']
