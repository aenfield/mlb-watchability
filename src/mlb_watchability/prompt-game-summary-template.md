...
- Before writing your summary, do at least two separate web searches: one for the latest news, storylines, and recent performance related to this specific game and both teams, and a second for the starting pitchers specifically (recent performance, injury reports). Query for the game with the date and time specified below in the "Game Details" section, to avoid getting information about other games that have similar teams and/or pitchers.
- At least a third of the summary should be built from specific, concrete things you found in your web searches - named storylines, injuries, recent results, matchup history - not just a restatement of the NERD components and their z-scores. If your web searches didn't turn up anything specific and concrete, say so explicitly in your summary rather than padding it out with more NERD-component detail.
