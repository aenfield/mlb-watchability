...
INTRO_TEXT = """Here are today's MLB games, ordered by watchability, based on how interesting the teams and starting pitchers look. Higher is better. For more information, [read this post](https://andrewenfield.com/blog/2025/08/07/how-to-choose-which-baseball-game-to-watch).
"""
...
def generate_team_breakdown_table(
    ...
    raw_row = (
        ...
        f"| {team_stats.broadcaster_rating:.2f} "
        f"| {team_stats.radio_broadcaster_rating:.2f} "
        f"| — "
        f"| — |"
    )
    ...
    z_row = (
        ...
        f"| {team_nerd_stats.z_broadcaster_rating:.2f} "
        f"| {team_nerd_stats.z_radio_broadcaster_rating:.2f} "
        f"| — "
        f"| — |"
    )
    ...
    tnerd_row = (
        ...
        f"| {team_nerd_stats.broadcaster_component:.2f} "
        f"| {team_nerd_stats.radio_broadcaster_component:.2f} "
