        ...
        data.update(
            {
                ...
                "away_bullpen_runs": team_stats.bullpen_runs,
                ...
                "away_z_bullpen_runs": away_team_details.z_bullpen_runs,
                "away_z_payroll": away_team_details.z_payroll,
                "away_z_age": away_team_details.z_age,
                "away_z_luck": away_team_details.z_luck,
                "away_batting_component": away_team_details.batting_component,
                "away_barrel_component": away_team_details.barrel_component,
                "away_baserunning_component": away_team_details.baserunning_component,
                "away_fielding_component": away_team_details.fielding_component,
                "away_bullpen_component": away_team_details.bullpen_component,
                "away_payroll_component": away_team_details.payroll_component,
                "away_age_component": away_team_details.age_component,
                "away_luck_component": away_team_details.luck_component,
            }
        )
    else:
        ...
        data.update(
            {
                ...
                "away_z_bullpen_runs": 0.0,
                "away_z_payroll": 0.0,
                "away_z_age": 0.0,
                "away_z_luck": 0.0,
                "away_batting_component": 0.0,
                "away_barrel_component": 0.0,
                "away_baserunning_component": 0.0,
                "away_fielding_component": 0.0,
                "away_bullpen_component": 0.0,
                "away_payroll_component": 0.0,
                "away_age_component": 0.0,
                "away_luck_component": 0.0,
            }
        )
        ...
        data.update(
            {
                ...
                "home_bullpen_runs": team_stats.bullpen_runs,
                ...
                "home_z_bullpen_runs": home_team_details.z_bullpen_runs,
                "home_z_payroll": home_team_details.z_payroll,
                "home_z_age": home_team_details.z_age,
                "home_z_luck": home_team_details.z_luck,
                "home_batting_component": home_team_details.batting_component,
                "home_barrel_component": home_team_details.barrel_component,
                "home_baserunning_component": home_team_details.baserunning_component,
                "home_fielding_component": home_team_details.fielding_component,
                "home_bullpen_component": home_team_details.bullpen_component,
                "home_payroll_component": home_team_details.payroll_component,
                "home_age_component": home_team_details.age_component,
                "home_luck_component": home_team_details.luck_component,
            }
        )
    else:
        # Default values if no team data
        data.update(
            {
                ...
                "home_z_bullpen_runs": 0.0,
                "home_z_payroll": 0.0,
                "home_z_age": 0.0,
                "home_z_luck": 0.0,
                "home_batting_component": 0.0,
                "home_barrel_component": 0.0,
                "home_baserunning_component": 0.0,
                "home_fielding_component": 0.0,
                "home_bullpen_component": 0.0,
                "home_payroll_component": 0.0,
                "home_age_component": 0.0,
                "home_luck_component": 0.0,
            }
        )
